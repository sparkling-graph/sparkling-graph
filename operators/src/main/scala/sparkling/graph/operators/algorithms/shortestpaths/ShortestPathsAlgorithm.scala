package sparkling.graph.operators.algorithms.shortestpaths


import java.util

import org.apache.spark.graphx._
import sparkling.graph.api.operators.algorithms.shortestpaths.ShortestPathsTypes.{JPathCollection, JLong}
import sparkling.graph.operators.algorithms.shortestpaths.pathprocessors._
import sparkling.graph.operators.algorithms.shortestpaths.pathprocessors.fastutils.{FastUtilWithPath, FastUtilWithDistance}
import sparkling.graph.operators.predicates.{ByIdPredicate, ByIdsPredicate, AllPathPredicate}
import scala.reflect.ClassTag
import sparkling.graph.api.operators.IterativeComputation._
