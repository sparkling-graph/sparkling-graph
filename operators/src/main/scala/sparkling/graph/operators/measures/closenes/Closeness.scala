package sparkling.graph.operators.measures.closenes

import org.apache.spark.graphx.Graph
import ClosenessUtils._
import sparkling.graph.api.operators.algorithms.shortestpaths.ShortestPathsTypes.{JDouble, JLong, JMap}
