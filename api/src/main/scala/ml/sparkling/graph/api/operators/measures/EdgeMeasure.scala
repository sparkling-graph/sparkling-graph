...
trait EdgeMeasure[O,V] extends Serializable{
  def computeValue[E:ClassTag](srcAttr:V,dstAttr:V,treatAsUndirected:Boolean=false):O

  def compute[E:ClassTag](graph:Graph[V,E],treatAsUndirected:Boolean=false)(implicit ot:ClassTag[O]): Graph[V,O] ={
    graph.mapTriplets(e=>computeValue[E](e.srcAttr,e.dstAttr,treatAsUndirected))
  }
